...
class Hero:
    def __init__(self,name):
        ...
        self.name=name
        #waluty
        self.currency_might = Currency(0,'attribute')
        self.currency_cunning = Currency(0,'attribute')
        self.currency_psyche = Currency(0,'attribute')
        self.currency_lore = Currency(0,'attribute')
